...
((core) =>
{
    function displayHome()
    {
        ...
        newParagraph.textContent = "This is a simple site to demonstrate DOM Manipulation for Lab 2";
...
/**
 * compare login username and password with those data from users.json
 * and redirect to Contact List page if login successfully
 *
 */
...
/***************************************************     displayRegister       ***************************************** */
    ...
    /**
     * check the validation of first name in register form                                                                            Lab 2 : 2(c)
    ...
    /**
     * check the validation of last name in register form                                                                            Lab 2 : 2(c)
     * by comparing the input string with name pattern
     */
    ...
    /**
     * check the validation of email address in register form                                                              Lab 2 : 2(d)
    ...
    {
      // add error message div tag to register form                                         Lab 2 : 2(b) 
      ...
      {
        // prevent the default form behaviour when submit button is clicked                    Lab 2 : 2(f)
        ...
        let userNameStr = firstName.val().toLowerCase() + lastName.val().toLowerCase();
        let newUser = new core.User(
          firstName.val(),
          lastName.val(),
          userNameStr,
        ...
        // display User class in the console.                                                 Lab 2 : 2(h)
        console.log(newUser);
