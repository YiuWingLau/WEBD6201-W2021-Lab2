...
/***************************************************     displayRegister       ***************************************** */
    ...
    function CheckFirstName()
    {
      ...
      $("#firstName").on("blur", function ()
      {
        ...
        if(!validation)
        {
          errorMessage.show().addClass("alert alert-danger").text("Please enter a valid Name. First name should have at least 2 characters and start with a uppercase letter.");
          $(this).trigger("focus").trigger("select");
        }
        else
        {
    ...
    function CheckLastName()
    {
      ...
      $("#lastName").on("blur", function ()
      {
        ...
        if(!validation)
        {
          errorMessage.show().addClass("alert alert-danger").text("Please enter a valid Name. Last name should have at least 2 characters and start with a uppercase letter.");
          $(this).trigger("focus").trigger("select");
        }
        else
        {
    ...
    function CheckPassword()
    {
      ...
      {
        let validation = emailPattern.test();
        if($(this).val() == "")
        {
          errorMessage.show().addClass("alert alert-danger").text("Please enter a password.");
          $(this).trigger("focus").trigger("select");
        }
        else
        {
